...
#### **6.1** Erstellen des Trainingsbeitrag-Issues
...
#### **6.3** Vorlage mit den richtigen Angaben und Inhalten füllen
...
4. Das Textfeld unter **Trainingsbeitrag** ist dein _body_ - hier fügst du also den Hauptteil deiner Inhalte ein.
   ...
   Und mache dir die **Markdown**-Integration zu Nutze! Die richtige **Formatierung** macht deinen Beitrag nicht nur "schöner", sondern auch übersichtlicher und damit verständlicher.
...
<!--screenshot "editor view aufgaben und checkliste"-->
...
<!--Screenshot "preview aufgabe mit ausklappbarer antwort"-->
...
<!--Screenshot "editor syntax dropdown"-->
...
<!--screenshot "show create sub-issue"-->
...
<!--Screenshot "show sub-issue nach erstellung"-->
...
<!--Screenshot "editor syntax sub-issue-link"-->

#

Du kannst in deiner Liste **Aufgaben beider Arten** miteinander kombinieren:

   <!--screenshot "preview aufgaben gemischt"-->
...
<!--screenshot "editor checkliste bearbeiten"-->
...
<!--Screenshot "beispiel branch benennung"-->
...
<!--Screenshot "preview output full"-->
