...
## 6. Wie bzw. wo wird der Trainingsbeitrag angelegt und dokumentiert?
...
**6.2** Es erscheint ein Pop-Up, in welchem du die Art des Issues auswählen kannst. Wähle hier **_Trainingsbeitrag_** aus.
...
**6.3** Super, du befindest dich jetzt in der Vorlage! Hier machst du folgende Angaben:
...
2. Dann suche dir im Dropdown-Menü unter "**Wählen des Themenbereichs für den Trainingbsbeitrag**" eine passende Kategorie für dein Thema aus und gehe zurück in das Eingabefeld von 3.1.
...
<br> <!--Screenshot antwort drowpdown--> 

   Komplexe(re) Übungsaufgaben, die für die Lösung Rechnungen, Code und/oder Ähnliches erfordern, werden wiederum als **Sub-Issue des Trainingsbeitrag-Issues** angelegt. 

   Überlege dir für das Aufgaben-Sub-Issue einen passenden, aber möglichst prägnanten Titel. Falls die Aufgabenstellung nicht zu lang ist, kannst du sie natürlich auch einfach ausformulieren. Diesen Titel verlinkst du nun in deiner Auflistung im Abschnitt **Aufgaben / Sub-Issues** samt ID.<!--Screenshot subissue aufgabe-->

   
   Du kannst hier beide Aufgaben-Arten gemischt miteinander auflisten.

   <!--screenshot aufgabenliste-->
   
   Jede Aufgabe, die ein separates Sub-Issue verlangt, wird im nächsten Abschnitt **Checkliste zur Abarbeitung** festgehalten und verlinkt.
<br>

---
**2. Checkliste zur Abarbeitung**: Dieser Abschnitt ist dafür da, um den Arbeitsfortschritt der Sub-Issue-Aufgaben zu tracken. 
...
Im Normalfall wirst du beim ersten Öffnen der Vorlage hier noch nichts eintragen können, da du bisher keine separaten Sub-Issues für Aufgaben erstellt hast. Das macht aber nichts, da du das Issue für deinen Trainingsbeitrag jederzeit bearbeiten und erweitern kannst. 

Verlinke in diesem Abschnitt - ggf. nachträglich - alle Sub-Issues, die du für Aufgaben zu deinem Trainingsbeitrag erstellt hast. Das Format für die Checkliste ist bereits vorgegeben. Du musst die Platzhalter eigentlich nur noch **durch die richtigen IDs ersetzen** sowie die **korrespondierenden Links zwischen den Klammern / ( ) einfügen**. 

<!--screenshot editor checkliste-->

Falls du weniger oder mehr als die 3 Platzhalter-Issues hast, kannst du **überflüssige Zeilen einfach entfernen** oder **per Copy-and-Paste weitere hinzufügen**. 
...
Jeder, der will, kann sich hier eine beliebige Aufgabe raussuchen und vom zugehörigen Sub-Issue aus einen Branch für die Bearbeitung erstellen. 

Die **Benennung des Branches** sollte mindestens den (Github-)**Namen des Team-Mitglieds** sowie die **ID des Issues** beinhalten, damit mehrere Leute dieselbe Aufgabe bearbeiten und ihre Ergebnisse einreichen können, ohne dass es zu Verwirrungen und/oder technischen Problemen aufgrund von 10 Branches mit demselben Default-Namen kommt.

<!--Screenshot beispiel branch-->

Sobald die erste bzw. mindestens eine Lösung für eine Aufgabe vorliegt, kann diese im Abschnitt **Checkliste zur Abarbeitung** abgehakt werden.

<!--screenshot aufgabe check-->


---
7. Geschafft - jetzt musst du nur noch auf **_Create issue_** klicken und dein Trainingsbeitrag geht _live_! So könnte dein fertiger Trainingsbeitrag am Ende ungefähr aussehen:
...
**Wichtig:** Wir l(i)eben saubere Dokumentation.
...
## 7. Wann und in welchem Discord-Kanal halte ich den Beitrag ab?
...
[Zurück](docs/01-organisation/11-training_und_vorbereitung/README.md) | [Weiter](docs/01-organisation/11-training_und_vorbereitung/02-praesentationstraining/README.md)